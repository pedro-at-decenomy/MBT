...
mbt.conf            | contains configuration settings for mbtd or mbt-qt
mbtd.pid            | stores the process id of mbtd while running
...
debug.log           | contains debug information and general logging generated by mbtd or mbt-qt
