...
This means one can have an always-on mbtd instance running, and another local mbtd/mbt-qt instance which connects to this node and receives blocks from it.
