Contributing to Mobolith Core
============================

The Mobolith Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mobolith Core project, and is not to be
confused with overall Mobolith Network Protocol consensus changes.

Whether a pull request is merged into Mobolith Core rests with the project merge
...
Patches that change Mobolith consensus rules are considerably more involved than
...
Where a patchset proposes to change the Mobolith consensus, it must have been
...
The project leader is the release manager for each Mobolith Core release.
