...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mobolith Core mbt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mbt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MBT transaction") + "\n" +
                               "  mbt-tx [options] -create [commands]   " + _("Create hex-encoded MBT transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Mobolith transaction
