...
/** Utility functions used by the Mobolith Qt UI.
 */
namespace GUIUtil
{
...
// Render Mobolith addresses in monospace font
...
// Parse "mbt:" URI into recipient object, return true on successful parsing
