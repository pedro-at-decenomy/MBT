 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Mobolith,
 * which enables instant payments to anyone, anywhere in the world. Mobolith uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    try {
        ...
        if (fDaemon) {
            fprintf(stdout, "Mobolith server starting\n");
